...
namespace Project.MVCUI.Controllers
{
    public class ShoppingController : Controller
    {
        ...
        // GET: Shopping
        public ActionResult ShoppingList(int? page, int? categoryID) //nullable int vermemizin sebebi aslında buradaki int'in sayfa sayımızı temsil edecek olmasıdır. Ancak birisi direkt alısveriş sayfasına ulastıgında sayfa sayısını göndermeyebilir de böylece bu sekilde de Action'in calısabilmesini istiyoruz...
        {
            ...
            PAVM pavm = new PAVM()
            {
                PagedProducts = categoryID == null ? pRep.GetActives().ToPagedList(page ?? 1, 9) : pRep.Where(x => x.CategoryID == categoryID).ToPagedList(page ?? 1, 9), //eger page parametresi null ise (??) sayfamız 1 olacak ve her sayfada 9 tane veri olacak
        ...
        //http://localhost:55735/api/Payment/ReceivePayment
        ...
        public ActionResult SiparisiOnayla(OrderVM ovm)
        {
            ...
            {
                client.BaseAddress = new Uri("http://localhost:55735/api/");
