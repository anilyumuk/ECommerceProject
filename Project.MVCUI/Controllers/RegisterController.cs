...
namespace Project.MVCUI.Controllers
{
    public class RegisterController : Controller
    {
        ...
        public ActionResult RegisterNow(AppUser AppUser, AppUserDetail AppUserDetail)
        {
            ...
            string gonderilecekMail = "Tebrikler.. Hesabınız olusturulmustur.. Hesabınızı aktive etmek icin http://localhost:55735/Home/Activation/" + AppUser.ActivationCode + " linkine tıklayabilirsiniz.";
